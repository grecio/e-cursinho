<%@ Page Title="" Language="C#" MasterPageFile="~/Painel.Master" AutoEventWireup="true" CodeBehind="FrmUsuario.aspx.cs" Inherits="Web.FrmUsuario" %>
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    ...
                    <asp:View ID="View2" runat="server">
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label5" runat="server" CssClass="lbl" Text="Login*:" Width="100px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtLogin" runat="server" CssClass="txt" MaxLength="20" Width="200px" autocomplete="off"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label6" runat="server" CssClass="lbl" Text="Senha*:"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtSenha" runat="server" CssClass="txt" MaxLength="20" TextMode="Password" Width="200px" autocomplete="off"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>

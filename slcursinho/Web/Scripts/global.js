function showRpt(rptName, rptParam, rptPopUp) {
    ...
    var pagina = 'reportviewer.aspx?rpt=' + rptName + '&param=' + rptParam + ''
    ...
    if (rptPopUp) {
        ...
        return window.open(pagina, 'Relatório', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=' + w + ', height=' + h + ', top=' + top + ', left=' + left);        

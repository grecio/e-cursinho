...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellspacing="1" style="width: 92%">
        <tr>
            <td class="linha">
                <asp:Label ID="Label1" runat="server" CssClass="tit" Text="Turmas"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <asp:MultiView ID="MultiView1" runat="server">
                                        ...
                                        <Columns>
                                            ...
                                            <ItemStyle HorizontalAlign="Center" />
                                             ...
                                             <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lkbInstrutures" runat="server" CausesValidation="False" CommandName="Instrutores" Text="Instrutores" ForeColor="#003300"></asp:LinkButton>
                                                </ItemTemplate>
                                                <HeaderStyle Width="7%" />
                                            </asp:TemplateField>
                                             ...
                                             <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lkbhorarios" runat="server" CausesValidation="False" CommandName="Horarios" Text="Horários" ForeColor="#003300"></asp:LinkButton>
                                                </ItemTemplate>
                                                <HeaderStyle Width="7%" />
                                            </asp:TemplateField>
                        ...
                        <table cellspacing="1" style="width: 100%">
                            <tr>
                                <td class="linha" colspan="3">
                                    <asp:Label ID="Label25" runat="server" CssClass="lbl" Font-Bold="True" Text="Dados da Turma"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                    ...
                    <asp:View runat="server" ID="View4">
                         <table cellspacing="1" style="width: 100%">
                            <tr>
                                <td class="linha" colspan="3">
                                    <asp:Label ID="Label3" runat="server" CssClass="lbl" Font-Bold="True" Text="Dados da turma"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                                    <table cellspacing="1" style="width: 100%">
                                        <tr>
                                            <td style="width: 15%;">
                                                <asp:Label ID="Label4" runat="server" CssClass="lbl" Font-Bold="False" Text="Turma:" Width="100px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblTurmaHorario_Turma" runat="server" CssClass="lbl" Font-Bold="False"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label8" runat="server" CssClass="lbl" Font-Bold="False" Text="Curso:" Width="100px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblTurmaHorario_Curso" runat="server" CssClass="lbl" Font-Bold="False"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                            ...
                            <tr>
                                <td class="linha" colspan="3">
                                    <asp:Label ID="Label10" runat="server" CssClass="lbl" Font-Bold="True" Text="Horários da Turma"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 15%;">
                                    <asp:Label ID="Label11" runat="server" CssClass="lbl" Text="Dia:" Width="100px"></asp:Label>
                                </td>
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlDia" runat="server" Width="340px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                             <tr>
                                 <td style="width: 15%;">
                                     <asp:Label ID="Label26" runat="server" CssClass="lbl" Text="Hora Inicial:" Width="100px"></asp:Label>
                                 </td>
                                 <td style="width:100%">
                                     <table cellspacing="1" style="width: 100%">
                                         <tr>
                                             <td style="width: 1%;">
                                                 <asp:TextBox ID="txtHoraInicial" runat="server" CssClass="txt mask-hora-curta" Width="80px"></asp:TextBox>
                                             </td>
                                             <td style="width: 1%;">
                                                 <asp:Label ID="Label27" runat="server" CssClass="lbl" Text="Hora Final:" Width="100px"></asp:Label>
                                             </td>
                                             <td style="width: 1%">
                                                 <asp:TextBox ID="txtHoraFinal" runat="server" CssClass="txt mask-hora-curta" Width="80px"></asp:TextBox>
                                             </td>
                                             <td>
                                                 <asp:Button ID="btnTurmaHorarioAdicionar" runat="server" CssClass="btn" OnClick="btnTurmaHorarioAdicionar_Click" Text=" &gt;&gt; " Width="40px" />
                                             </td>
                                         </tr>
                                     </table>
                                 </td>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td colspan="2">
                                    <asp:GridView ID="grdTurmaHorarioList" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" CssClass="Grid" DataKeyNames="IdTurmaHorario" EmptyDataText="Nenhum registro encontrado" Width="100%" OnPageIndexChanging="grdTurmaHorarioList_PageIndexChanging" OnRowCommand="grdTurmaHorarioList_RowCommand" OnRowDataBound="grdTurmaHorarioList_RowDataBound">
                                        <AlternatingRowStyle CssClass="GridAltItem" />
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="horasaida" HeaderText="Saída">
                                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                            <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lkbTurmaHorarioRemover" runat="server" CausesValidation="False" CommandName="Excluir" Text="Remover"></asp:LinkButton>
                                                </ItemTemplate>
                                                <HeaderStyle Width="7%" />
                                            </asp:TemplateField>
                                        </Columns>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td colspan="2">
                                    <asp:Button ID="btnTurmaHorarioVoltar" runat="server" CssClass="btn" OnClick="btnTurmaHorarioVoltar_Click" Text="Voltar" />
                                </td>
                            </tr>
                        </table>
                    </asp:View>

...
namespace Framework.Web
{
    public static class JavaScriptAJAX
    {
        ...
        public static void ShowRPT(System.Web.UI.Page oPage, string strRpt, string strParam)
        {

            ScriptManager.RegisterStartupScript(oPage, typeof(string), Guid.NewGuid().ToString(), string.Format("showRpt('{0}', '{1}');", strRpt, strParam), true);            
